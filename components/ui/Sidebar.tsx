  ...
  return (
    <>
      ...
      <aside
        ...
        className="w-60 fixed- md:fixed- hidden- md:visible- md:w-60 z-40 h-screen transition-transform -translate-x-full sm:translate-x-0"
        // className={`z-40 h-screen transition-transform ${isSidebarHidden ? "-translate-x-full" : "translate-x-0"}`}
        // className={`z-40 h-screen transition-transform ${isSidebarHidden ? "-translate-x-full" : "translate-x-0"}`}
        aria-label="Sidebar"
      >
        <div className="w-60 hidden- md:visible- md:w-60- h-full px-3 pb-4 overflow-y-auto bg-gray-900 ">
