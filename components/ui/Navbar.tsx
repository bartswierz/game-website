  ...
  return (
    <header>
      ...
      <nav className="flex flex-row justify-between items-center bg-gray-900 p-4 shadow text-white font-bold">
        <Link href="/" className="cursor-pointer hover:text-gray-300 text-xl">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ height: "60px", width: "60px" }}>
            <defs>
              <linearGradient id="caro-asercion-warlord-helmet-gradient-0">
                <stop offset="0%" stop-color="#fe080a" stop-opacity="1"></stop>
                <stop offset="100%" stop-color="#131bfe" stop-opacity="1"></stop>
              </linearGradient>
              <linearGradient x1="0" x2="1" y1="0" y2="1" id="caro-asercion-warlord-helmet-gradient-1">
                <stop offset="0%" stop-color="#999595" stop-opacity="1"></stop>
                <stop offset="100%" stop-color="#0a0000" stop-opacity="1"></stop>
              </linearGradient>
            </defs>
            <polygon
