    ...
    <header>
      ...
      <nav className="flex flex-row justify-between- items-center bg-gray-900 p-4 shadow text-white font-bold">
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-white rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
