    ...
    <div>
      ...
      <div className="flex items-center mt-4">
        ...
        <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
          {/* <div className="h-5 bg-yellow-300 rounded" styles={"width: 70%"} ></div> */}
          <div className="h-5 bg-yellow-300 rounded" style={{ width: "width: 70%" }}></div>
        </div>
      ...
      <div className="flex items-center mt-4">
        ...
        <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
          <div className="h-5 bg-yellow-300 rounded" style={{ width: "width: 37%" }}></div>
        </div>
      ...
      <div className="flex items-center mt-4">
        ...
        <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
          <div className="h-5 bg-yellow-300 rounded" style={{ width: "width: 8%" }}></div>
        </div>
      ...
      <div className="flex items-center mt-4">
        ...
        <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
          <div className="h-5 bg-yellow-300 rounded" style={{ width: "width: 4%" }}></div>
        </div>
      ...
      <div className="flex items-center mt-4">
        ...
        <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
          <div className={`h-5 bg-red-300 rounded w-[50%]`}></div>
          {/* <div className={`h-5 bg-yellow-300 rounded w-[${30}]`} style={{ width: "width: 1%" }}></div> */}
        </div>
